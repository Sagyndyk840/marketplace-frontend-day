    ...
    <div class="container">
      <div class="catalog-inner">
        ...
        <div class="catalog-right">
          ...
          <div v-if="productStore.loading" class="catalog-products">
            <skeleton
                height="340px"
                class="catalog-item" v-for="index in 9" :key="index"/>
          </div>
          <div v-else class="catalog-products">
        ...
        <vue-awesome-paginate
                v-model="productStore.currentPaginate"
